...
def run_sbhh_alone():
    print("==========================================================")
    print("🧠 LANCEMENT DU SOLVEUR 2 : SEQUENCE-BASED HYPER-HEURISTIC")
    print("==========================================================\n")
    ...
    print("[2] Initialisation de l'apprentissage (20 000 Iterations)...")
    solver = SBHHFSTMSolver(modules, rooms, slots, calculator)
    
    # 3. Exécution avec chronomètre
    start_time = time.time()
    best_table = solver.solve(max_iterations=20000)
