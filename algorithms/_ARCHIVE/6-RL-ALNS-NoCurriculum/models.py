...
class ModulePart:
    def __init__(self, id, module_id, teacher_id, section_id, type="TD", required_room_type="SALLE_TD", group_size=30, td_group_ids=None, is_locked=False, fixed_room_id=None, fixed_slot_id=None, unavailable_slots=None):
        self.id = id
