...
class HybridEngine:
    ...
    def _build_greedy_individual(self):
        ...
        # On trie par taille (Plus gros CM en premier) pour garantir l'accès aux Amphis
        mp_shuffled.sort(key=lambda x: x.group_size, reverse=True) 
